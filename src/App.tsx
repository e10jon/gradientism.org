  ...
  return (
    <div className="max-w-3xl mx-auto px-8 py-12 bg-white text-gray-900">
      <header className="mb-8 pb-8 border-b border-gray-300">
        <h1 className="text-4xl font-serif mb-5 text-gray-900">Gradientism</h1>
        <p className="text-lg text-gray-700 font-serif italic">
          The belief that the ultimate measure of value is a system’s capacity to perceive,
          generate, and sustain energy and information gradients that enable continued dissipation
          and evolution.
        </p>
      </header>
      ...
      <section className="mb-8">
        ...
        <div className="space-y-8">
          <article className="pb-6 border-b border-gray-200">
            <h3 className="text-xl mb-3 text-gray-900">1. Conservation and Degradation</h3>
          ...
          <article className="pb-6 border-b border-gray-200">
            <h3 className="text-xl mb-3 text-gray-900">2. Persistence Requires Dissipation</h3>
            <p className="text-gray-700 leading-relaxed mb-3">
          ...
          <article className="pb-6 border-b border-gray-200">
            <h3 className="text-xl mb-3 text-gray-900">3. Selection Favors Greater Dissipation</h3>
            <p className="text-gray-700 leading-relaxed mb-3">
          ...
          <article className="pb-6 border-b border-gray-200">
            ...
            <p className="text-gray-700 leading-relaxed mb-3">
              Because the low-entropy substrate is finite, long-term persistence requires not only
          ...
          <article>
            <h3 className="text-xl mb-3 text-gray-900">7. Value as Persistence</h3>
            <p className="text-gray-700 leading-relaxed mb-3">
